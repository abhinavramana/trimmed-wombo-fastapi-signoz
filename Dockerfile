...
CMD opentelemetry-instrument --logs_exporter otlp_proto_grpc --traces_exporter otlp_proto_grpc --metrics_exporter otlp_proto_grpc,console gunicorn wombo.fastapi:app --workers 2 --worker-class uvicorn.workers.UvicornH11Worker